...
AmazonRESTAPI.prototype.encrypt = function (url, method, version, app_secret) {
		...
		var secret_key = new SecretKeySpec(String(app_secret).getBytes(), String("HmacSHA256"));
		sha256_HMAC.init(secret_key);
		var sign = sha256_HMAC.doFinal(String(orgin).getBytes());

		var signBase64 = new Base64().encodeBase64(String(sign).getBytes());
